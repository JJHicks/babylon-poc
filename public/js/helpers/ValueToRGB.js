...
/**
 *
 * @param minval - Max value of the range
 * @param maxval - Min value of the range
 * @param val - Value for color to be calculated
 * @param colors - Array of RGB tuples for color gradients
 */
function convertToRGB(minval, maxval, val, colors = [[0, 0, 255], [0, 255, 0], [255, 0, 0]]) {
...
exports.default = convertToRGB;
//# sourceMappingURL=ValueToRGB.js.map